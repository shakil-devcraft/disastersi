...
const ButtonSecondary = ({text2, icon2, onClick2, className2}) => {
    ...
    return (
        <>
           <button
            onClick={onClick2}
            className={`py-[12px] px-[25px] rounded-lg text-[12px] font-bold text-white bg-primary hover:text-t-secondary hover:bg-white transition-colors duration-300 ${className2}`}
            >
